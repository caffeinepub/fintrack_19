...
import type { CategoryID as _CategoryID } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addRule(arg0: string, arg1: CategoryID): Promise<RuleID> {
        if (this.processError) {
            try {
    ...
    async addTransaction(arg0: number, arg1: string, arg2: Time, arg3: CategoryID | null): Promise<TransactionID> {
        if (this.processError) {
            try {
                const result = await this.actor.addTransaction(arg0, arg1, arg2, to_candid_opt_n1(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
